  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1101')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1101')]">
        Unit-1101
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1101')]">
        01 BR
      </text>
      <!-- 1102 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1102')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1102')]">
        Unit-1102
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1102')]">
        Studio
      </text>
      <!-- 1103 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1103')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1103')]">
        Unit-1103
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1103')]">
        Studio
      </text>
      <!-- 1105 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1105')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1105')]">
        Unit-1105
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1105')]">
        01 BR
      </text>
      <!-- 1106 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1106')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1106')]">
        Unit-1106
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1106')]">
        Studio
      </text>
      <!-- 1107 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1107')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1107')]">
        Unit-1107
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1107')]">
        Studio
      </text>
      <!-- 1108 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1108')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1108')]">
        Unit-1108
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1108')]">
        Studio
      </text>
      <!-- 1109 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1109')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1109')]">
        Unit-1109
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1109')]">
        Studio
      </text>
      <!-- 1110 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1110')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1110')]">
        Unit-1110
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1110')]">
        Studio
      </text>
      <!-- 1111 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1111')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1111')]">
        Unit-1111
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1111')]">
        Studio
      </text>
      <!-- 1112-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1112')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1112')]">
        Unit-1112
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1112')]">
        01 BR
      </text>
      <!-- 1115 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1115')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1115')]">
        Unit-1115
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1115')]">
        Studio
      </text>
      <!-- 1116 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1116')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1116')]">
        Unit-1116
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1116')]">
        Studio
      </text>
      <!-- 1117 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1117')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1117')]">
        Unit-1117
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1117')]">
        01 BR
      </text>
      <!-- 1118 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1118')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1118')]">
        Unit-1118
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1118')]">
        Studio
      </text>
      <!-- 1119 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1119')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1119')]">
        Unit-1119
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1119')]">
        Studio
      </text>
      <!-- 1120 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1120')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1120')]">
        Unit-1120
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1120')]">
        Studio
      </text>
      <!-- 1121 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1121')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1121')]">
        Unit-1121
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1121')]">
        Studio
      </text>
      <!-- 1122 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1122')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1122')]">
        Unit-1122
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1122')]">
        Studio
      </text>
      <!-- 1123 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1123')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1123')]">
        Unit-1123
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1123')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "11th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "11th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "11th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "11th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "11th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
