  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1201')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1201')]">
        Unit-1201
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1201')]">
        01 BR
      </text>
      <!-- 1202 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1202')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1202')]">
        Unit-1202
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1202')]">
        Studio
      </text>
      <!-- 1203 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1203')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1203')]">
        Unit-1203
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1203')]">
        Studio
      </text>
      <!-- 1205 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1205')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1205')]">
        Unit-1205
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1205')]">
        01 BR
      </text>
      <!-- 1206 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1206')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1206')]">
        Unit-1206
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1206')]">
        Studio
      </text>
      <!-- 1207 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1207')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1207')]">
        Unit-1207
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1207')]">
        Studio
      </text>
      <!-- 1208 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1208')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1208')]">
        Unit-1208
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1208')]">
        Studio
      </text>
      <!-- 1209 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1209')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1209')]">
        Unit-1209
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1209')]">
        Studio
      </text>
      <!-- 1210 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1210')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1210')]">
        Unit-1210
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1210')]">
        Studio
      </text>
      <!-- 1211 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1211')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1211')]">
        Unit-1211
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1211')]">
        Studio
      </text>
      <!-- 1212-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1212')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1212')]">
        Unit-1212
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1212')]">
        01 BR
      </text>
      <!-- 1215 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1215')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1215')]">
        Unit-1215
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1215')]">
        Studio
      </text>
      <!-- 1216 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1216')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1216')]">
        Unit-1216
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1216')]">
        Studio
      </text>
      <!-- 1217 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1217')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1217')]">
        Unit-1217
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1217')]">
        01 BR
      </text>
      <!-- 1218 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1218')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1218')]">
        Unit-1218
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1218')]">
        Studio
      </text>
      <!-- 1219 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1219')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1219')]">
        Unit-1219
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1219')]">
        Studio
      </text>
      <!-- 1220 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1220')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1220')]">
        Unit-1220
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1220')]">
        Studio
      </text>
      <!-- 1221 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1221')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1221')]">
        Unit-1221
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1221')]">
        Studio
      </text>
      <!-- 1222 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1222')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1222')]">
        Unit-1222
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1222')]">
        Studio
      </text>
      <!-- 1223 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1223')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1223')]">
        Unit-1223
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1223')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "12th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "12th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "12th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "12th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "12th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
