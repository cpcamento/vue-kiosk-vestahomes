  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1601')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1601')]">
        Unit-1601
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1601')]">
        01 BR
      </text>
      <!-- 1602 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1602')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1602')]">
        Unit-1602
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1602')]">
        Studio
      </text>
      <!-- 1603 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1603')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1603')]">
        Unit-1603
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1603')]">
        Studio
      </text>
      <!-- 1605 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1605')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1605')]">
        Unit-1605
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1605')]">
        01 BR
      </text>
      <!-- 1606 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1606')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1606')]">
        Unit-1606
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1606')]">
        Studio
      </text>
      <!-- 1607 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1607')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1607')]">
        Unit-1607
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1607')]">
        Studio
      </text>
      <!-- 1608 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1608')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1608')]">
        Unit-1608
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1608')]">
        Studio
      </text>
      <!-- 1609 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1609')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1609')]">
        Unit-1609
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1609')]">
        Studio
      </text>
      <!-- 1610 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1610')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1610')]">
        Unit-1610
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1610')]">
        Studio
      </text>
      <!-- 1611 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1611')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1611')]">
        Unit-1611
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1611')]">
        Studio
      </text>
      <!-- 1612-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1612')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1612')]">
        Unit-1612
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1612')]">
        01 BR
      </text>
      <!-- 1615 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1615')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1615')]">
        Unit-1615
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1615')]">
        Studio
      </text>
      <!-- 1616 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1616')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1616')]">
        Unit-1616
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1616')]">
        Studio
      </text>
      <!-- 1617 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1617')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1617')]">
        Unit-1617
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1617')]">
        01 BR
      </text>
      <!-- 1618 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1618')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1618')]">
        Unit-1618
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1618')]">
        Studio
      </text>
      <!-- 1619 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1619')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1619')]">
        Unit-1619
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1619')]">
        Studio
      </text>
      <!-- 1620 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1620')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1620')]">
        Unit-1620
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1620')]">
        Studio
      </text>
      <!-- 1621 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1621')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1621')]">
        Unit-1621
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1621')]">
        Studio
      </text>
      <!-- 1622 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1622')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1622')]">
        Unit-1622
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1622')]">
        Studio
      </text>
      <!-- 1623 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1623')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1623')]">
        Unit-1623
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1623')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "16th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "16th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "16th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "16th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "16th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
