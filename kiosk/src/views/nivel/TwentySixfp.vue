  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('2601')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('2601')]">
        Unit-2601
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('2601')]">
        01 BR
      </text>
      <!-- 2602 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('2602')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('2602')]">
        Unit-2602
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('2602')]">
        Studio
      </text>
      <!-- 2603 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('2603')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('2603')]">
        Unit-2603
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('2603')]">
        Studio
      </text>
      <!-- 2605 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('2605')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('2605')]">
        Unit-2605
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('2605')]">
        01 BR
      </text>
      <!-- 2606 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('2606')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('2606')]">
        Unit-2606
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('2606')]">
        Studio
      </text>
      <!-- 2607 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('2607')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('2607')]">
        Unit-2607
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('2607')]">
        Studio
      </text>
      <!-- 2608 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('2608')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('2608')]">
        Unit-2608
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('2608')]">
        Studio
      </text>
      <!-- 2609 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('2609')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('2609')]">
        Unit-2609
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('2609')]">
        Studio
      </text>
      <!-- 2610 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('2610')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('2610')]">
        Unit-2610
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('2610')]">
        Studio
      </text>
      <!-- 2611 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('2611')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('2611')]">
        Unit-2611
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('2611')]">
        Studio
      </text>
      <!-- 2612-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('2612')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('2612')]">
        Unit-2612
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('2612')]">
        01 BR
      </text>
      <!-- 2615 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('2615')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('2615')]">
        Unit-2615
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('2615')]">
        Studio
      </text>
      <!-- 2616 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('2616')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('2616')]">
        Unit-2616
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('2616')]">
        Studio
      </text>
      <!-- 2617 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('2617')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('2617')]">
        Unit-2617
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('2617')]">
        01 BR
      </text>
      <!-- 2618 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('2618')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('2618')]">
        Unit-2618
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('2618')]">
        Studio
      </text>
      <!-- 2619 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('2619')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('2619')]">
        Unit-2619
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('2619')]">
        Studio
      </text>
      <!-- 2620 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('2620')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('2620')]">
        Unit-2620
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('2620')]">
        Studio
      </text>
      <!-- 2621 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('2621')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('2621')]">
        Unit-2621
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('2621')]">
        Studio
      </text>
      <!-- 2622 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('2622')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('2622')]">
        Unit-2622
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('2622')]">
        Studio
      </text>
      <!-- 2623 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('2623')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('2623')]">
        Unit-2623
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('2623')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "26th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "26th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "26th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "26th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "26th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
