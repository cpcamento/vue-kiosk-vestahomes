  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('2101')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('2101')]">
        Unit-2101
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('2101')]">
        01 BR
      </text>
      <!-- 2102 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('2102')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('2102')]">
        Unit-2102
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('2102')]">
        Studio
      </text>
      <!-- 2103 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('2103')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('2103')]">
        Unit-2103
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('2103')]">
        Studio
      </text>
      <!-- 2105 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('2105')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('2105')]">
        Unit-2105
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('2105')]">
        01 BR
      </text>
      <!-- 2106 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('2106')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('2106')]">
        Unit-2106
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('2106')]">
        Studio
      </text>
      <!-- 2107 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('2107')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('2107')]">
        Unit-2107
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('2107')]">
        Studio
      </text>
      <!-- 2108 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('2108')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('2108')]">
        Unit-2108
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('2108')]">
        Studio
      </text>
      <!-- 2109 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('2109')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('2109')]">
        Unit-2109
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('2109')]">
        Studio
      </text>
      <!-- 2110 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('2110')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('2110')]">
        Unit-2110
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('2110')]">
        Studio
      </text>
      <!-- 2111 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('2111')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('2111')]">
        Unit-2111
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('2111')]">
        Studio
      </text>
      <!-- 2112-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('2112')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('2112')]">
        Unit-2112
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('2112')]">
        01 BR
      </text>
      <!-- 2115 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('2115')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('2115')]">
        Unit-2115
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('2115')]">
        Studio
      </text>
      <!-- 2116 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('2116')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('2116')]">
        Unit-2116
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('2116')]">
        Studio
      </text>
      <!-- 2117 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('2117')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('2117')]">
        Unit-2117
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('2117')]">
        01 BR
      </text>
      <!-- 2118 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('2118')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('2118')]">
        Unit-2118
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('2118')]">
        Studio
      </text>
      <!-- 2119 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('2119')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('2119')]">
        Unit-2119
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('2119')]">
        Studio
      </text>
      <!-- 2120 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('2120')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('2120')]">
        Unit-2120
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('2120')]">
        Studio
      </text>
      <!-- 2121 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('2121')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('2121')]">
        Unit-2121
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('2121')]">
        Studio
      </text>
      <!-- 2122 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('2122')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('2122')]">
        Unit-2122
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('2122')]">
        Studio
      </text>
      <!-- 2123 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('2123')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('2123')]">
        Unit-2123
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('2123')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "21st" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "21st" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "21st" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "21st" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "21st" && data.availability === "Hayat"
      ).length;
    } catch (error) {
