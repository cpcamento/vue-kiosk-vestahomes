  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('801')]"
      ></path>
      <text x="100" y="50" :class="['label', getParkingStatus('801')]">
        Unit-801
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('801')]">
        01 BR
      </text>
      <!-- 802 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('802')]"
      ></path>
      <text x="225" y="95" :class="['label', getParkingStatus('802')]">
        Unit-802
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('802')]">
        Studio
      </text>
      <!-- 803 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('803')]"
      ></path>
      <text x="295" y="95" :class="['label', getParkingStatus('803')]">
        Unit-803
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('803')]">
        Studio
      </text>
      <!-- 805 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('805')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('805')]">
        Unit-805
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('805')]">
        01 BR
      </text>
      <!-- 806 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('806')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('806')]">
        Unit-806
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('806')]">
        Studio
      </text>
      <!-- 807 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('807')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('807')]">
        Unit-807
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('807')]">
        Studio
      </text>
      <!-- 808 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('808')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('808')]">
        Unit-808
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('808')]">
        Studio
      </text>
      <!-- 809 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('809')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('809')]">
        Unit-809
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('809')]">
        Studio
      </text>
      <!-- 810 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('810')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('810')]">
        Unit-810
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('810')]">
        Studio
      </text>
      <!-- 811 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('811')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('811')]">
        Unit-811
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('811')]">
        Studio
      </text>
      <!-- 812-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('812')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('812')]">
        Unit-812
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('812')]">
        01 BR
      </text>
      <!-- 815 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('815')]"
      ></path>
      <text x="295" y="455" :class="['label', getParkingStatus('815')]">
        Unit-815
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('815')]">
        Studio
      </text>
      <!-- 816 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('816')]"
      ></path>
      <text x="225" y="455" :class="['label', getParkingStatus('816')]">
        Unit-816
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('816')]">
        Studio
      </text>
      <!-- 817 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('817')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('817')]">
        Unit-817
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('817')]">
        01 BR
      </text>
      <!-- 818 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('818')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('818')]">
        Unit-818
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('818')]">
        Studio
      </text>
      <!-- 819 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('819')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('819')]">
        Unit-819
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('819')]">
        Studio
      </text>
      <!-- 820 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('820')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('820')]">
        Unit-820
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('820')]">
        Studio
      </text>
      <!-- 821 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('821')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('821')]">
        Unit-821
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('821')]">
        Studio
      </text>
      <!-- 822 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('822')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('822')]">
        Unit-822
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('822')]">
        Studio
      </text>
      <!-- 823 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('823')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('823')]">
        Unit-823
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('823')]">
        Studio
      </text>
      ...
      <g class="legend">
        <rect
          ...
          rx="5"
        ></rect>
        <text x="710" y="180" style="font-weight: 900; font-size: 20px">
          8TH FLOOR - PROJECT 2
        </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "8th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "8th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "8th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "8th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "8th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
