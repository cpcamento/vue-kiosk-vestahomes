  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1701')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1701')]">
        Unit-1701
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1701')]">
        01 BR
      </text>
      <!-- 1702 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1702')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1702')]">
        Unit-1702
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1702')]">
        Studio
      </text>
      <!-- 1703 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1703')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1703')]">
        Unit-1703
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1703')]">
        Studio
      </text>
      <!-- 1705 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1705')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1705')]">
        Unit-1705
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1705')]">
        01 BR
      </text>
      <!-- 1706 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1706')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1706')]">
        Unit-1706
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1706')]">
        Studio
      </text>
      <!-- 1707 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1707')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1707')]">
        Unit-1707
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1707')]">
        Studio
      </text>
      <!-- 1708 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1708')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1708')]">
        Unit-1708
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1708')]">
        Studio
      </text>
      <!-- 1709 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1709')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1709')]">
        Unit-1709
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1709')]">
        Studio
      </text>
      <!-- 1710 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1710')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1710')]">
        Unit-1710
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1710')]">
        Studio
      </text>
      <!-- 1711 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1711')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1711')]">
        Unit-1711
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1711')]">
        Studio
      </text>
      <!-- 1712-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1712')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1712')]">
        Unit-1712
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1712')]">
        01 BR
      </text>
      <!-- 1715 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1715')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1715')]">
        Unit-1715
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1715')]">
        Studio
      </text>
      <!-- 1716 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1716')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1716')]">
        Unit-1716
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1716')]">
        Studio
      </text>
      <!-- 1717 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1717')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1717')]">
        Unit-1717
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1717')]">
        01 BR
      </text>
      <!-- 1718 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1718')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1718')]">
        Unit-1718
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1718')]">
        Studio
      </text>
      <!-- 1719 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1719')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1719')]">
        Unit-1719
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1719')]">
        Studio
      </text>
      <!-- 1720 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1720')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1720')]">
        Unit-1720
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1720')]">
        Studio
      </text>
      <!-- 1721 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1721')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1721')]">
        Unit-1721
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1721')]">
        Studio
      </text>
      <!-- 1722 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1722')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1722')]">
        Unit-1722
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1722')]">
        Studio
      </text>
      <!-- 1723 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1723')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1723')]">
        Unit-1723
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1723')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "17th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "17th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "17th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "17th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "17th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
