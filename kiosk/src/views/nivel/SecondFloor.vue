    ...
    >
      <g style="transform: scale(0.8)">
        ...
        <g transform="translate(75, 170)">
          ...
          <text x="227" y="179" class="label">STORAGE</text>
          <text x="285" y="144" class="label">PWD</text>
          <text x="284" y="150" class="label">RAMP</text>
        ...
        <g>
          ...
          ></path>
          <path
            d="M 620 21 L 620 80 M 620 80 L 560 450 M 560 450 C 560 490 500 490 500 490 M 500 490 L 250 490"
            class="f-transparent"
          ></path>
          <path
            d="M 622 21 L 622 82 M 622 82 L 562 452 M 562 452 C 562 492 502 492 502 492 M 502 492 L 250 492"
            class="f-transparent"
          ></path>
          <path
            d="M 215 495 L 345 495 M 345 495 L 345 510 M 345 510 L 365 510 M 215 495 L 215 573 M 345 535 L 345 596"
            stroke-width="2"
            class="f-transparent"
          ></path>
          <path
            d="M 365 510 C 365 535 345 535 345 535"
            stroke-width="1"
            class="f-transparent s-grey"
          ></path>
          <path
            d="M 345 495 L 460 495 M 460 495 L 460 610"
            stroke-width="2"
          ></path>
          <path
          ...
          ></rect>
          <path
            d="M 93 92 L 93 457 M 93 457 L 118 457 M 118 457 L 118 550"
            stroke-linecap="round"
            stroke-linejoin="round"
            class="s-grey"
          ></path>
          <path
            d="M 95 92 L 95 455 M 95 455 L 120 455 M 120 455 L 120 550"
            stroke-linecap="round"
            stroke-linejoin="round"
            stroke-width="2"
            class="s-grey"
          ...
          <path d="M 50 92 L 200 92 M 200 92 L 200 20" stroke-width="2"></path>
        ...
        <g>
          ...
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('1')]"
          ></rect>
          <text x="190" y="530" :class="['label', getParkingStatus('1')]">
            1
          </text>
          <!-- 2 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('2')]"
          ></rect>
          <text x="150" y="525" :class="['label', getParkingStatus('2')]">
            2
          </text>
          <!-- 3 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('3')]"
          ></rect>
          <text x="180" y="310" :class="['label', getParkingStatus('3')]">
            3
          </text>
          <!-- 4 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('4')]"
          ></rect>
          <text x="180" y="245" :class="['label', getParkingStatus('4')]">
            4
          </text>
          <!-- 5 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('5')]"
          ></rect>
          <text x="275" y="60" :class="['label', getParkingStatus('5')]">
            5
          </text>
          <!-- 6 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('6')]"
          ></rect>
          <text x="314" y="60" :class="['label', getParkingStatus('6')]">
            6
          </text>
          <!-- 7 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('7')]"
          ></rect>
          <text x="409" y="60" :class="['label', getParkingStatus('7')]">
            7
          </text>
          <!-- 8 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('8')]"
          ></rect>
          <text x="448" y="60" :class="['label', getParkingStatus('8')]">
            8
          </text>
          <!-- 9 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('9')]"
          ></rect>
          <text x="543" y="60" :class="['label', getParkingStatus('9')]">
            9
          </text>
          <!-- 10 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('10')]"
          ></rect>
          <text x="575" y="60" :class="['label', getParkingStatus('10')]">
            10
          </text>
          <!-- 11 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('11')]"
          ></rect>
          <text x="444" y="245" :class="['label', getParkingStatus('11')]">
            11
          </text>
          <!-- 12 -->
          <rect
            ...
            width="39"
            height="70"
            :class="['unit', getParkingStatus('12')]"
            style="transform: rotate(7deg)"
          ></rect>
          <text x="440" y="318" :class="['label', getParkingStatus('12')]">
            12
          </text>
        </g>
        <image
          ...
          style="transform: translate(407px, 64px)"
        ></image>
      </g>
      <g class="legend">
        <rect
