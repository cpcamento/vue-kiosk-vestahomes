  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1501')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1501')]">
        Unit-1501
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1501')]">
        01 BR
      </text>
      <!-- 1502 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1502')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1502')]">
        Unit-1502
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1502')]">
        Studio
      </text>
      <!-- 1503 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1503')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1503')]">
        Unit-1503
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1503')]">
        Studio
      </text>
      <!-- 1505 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1505')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1505')]">
        Unit-1505
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1505')]">
        01 BR
      </text>
      <!-- 1506 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1506')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1506')]">
        Unit-1506
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1506')]">
        Studio
      </text>
      <!-- 1507 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1507')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1507')]">
        Unit-1507
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1507')]">
        Studio
      </text>
      <!-- 1508 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1508')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1508')]">
        Unit-1508
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1508')]">
        Studio
      </text>
      <!-- 1509 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1509')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1509')]">
        Unit-1509
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1509')]">
        Studio
      </text>
      <!-- 1510 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1510')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1510')]">
        Unit-1510
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1510')]">
        Studio
      </text>
      <!-- 1511 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1511')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1511')]">
        Unit-1511
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1511')]">
        Studio
      </text>
      <!-- 1512-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1512')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1512')]">
        Unit-1512
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1512')]">
        01 BR
      </text>
      <!-- 1515 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1515')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1515')]">
        Unit-1515
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1515')]">
        Studio
      </text>
      <!-- 1516 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1516')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1516')]">
        Unit-1516
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1516')]">
        Studio
      </text>
      <!-- 1517 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1517')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1517')]">
        Unit-1517
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1517')]">
        01 BR
      </text>
      <!-- 1518 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1518')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1518')]">
        Unit-1518
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1518')]">
        Studio
      </text>
      <!-- 1519 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1519')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1519')]">
        Unit-1519
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1519')]">
        Studio
      </text>
      <!-- 1520 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1520')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1520')]">
        Unit-1520
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1520')]">
        Studio
      </text>
      <!-- 1521 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1521')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1521')]">
        Unit-1521
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1521')]">
        Studio
      </text>
      <!-- 1522 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1522')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1522')]">
        Unit-1522
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1522')]">
        Studio
      </text>
      <!-- 1523 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1523')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1523')]">
        Unit-1523
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1523')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "15th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "15th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "15th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "15th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "15th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
