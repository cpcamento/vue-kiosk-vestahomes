  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1901')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1901')]">
        Unit-1901
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1901')]">
        01 BR
      </text>
      <!-- 1902 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1902')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1902')]">
        Unit-1902
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1902')]">
        Studio
      </text>
      <!-- 1903 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1903')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1903')]">
        Unit-1903
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1903')]">
        Studio
      </text>
      <!-- 1905 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1905')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1905')]">
        Unit-1905
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1905')]">
        01 BR
      </text>
      <!-- 1906 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1906')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1906')]">
        Unit-1906
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1906')]">
        Studio
      </text>
      <!-- 1907 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1907')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1907')]">
        Unit-1907
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1907')]">
        Studio
      </text>
      <!-- 1908 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1908')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1908')]">
        Unit-1908
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1908')]">
        Studio
      </text>
      <!-- 1909 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1909')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1909')]">
        Unit-1909
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1909')]">
        Studio
      </text>
      <!-- 1910 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1910')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1910')]">
        Unit-1910
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1910')]">
        Studio
      </text>
      <!-- 1911 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1911')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1911')]">
        Unit-1911
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1911')]">
        Studio
      </text>
      <!-- 1912-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1912')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1912')]">
        Unit-1912
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1912')]">
        01 BR
      </text>
      <!-- 1915 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1915')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1915')]">
        Unit-1915
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1915')]">
        Studio
      </text>
      <!-- 1916 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1916')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1916')]">
        Unit-1916
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1916')]">
        Studio
      </text>
      <!-- 1917 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1917')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1917')]">
        Unit-1917
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1917')]">
        01 BR
      </text>
      <!-- 1918 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1918')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1918')]">
        Unit-1918
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1918')]">
        Studio
      </text>
      <!-- 1919 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1919')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1919')]">
        Unit-1919
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1919')]">
        Studio
      </text>
      <!-- 1920 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1920')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1920')]">
        Unit-1920
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1920')]">
        Studio
      </text>
      <!-- 1921 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1921')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1921')]">
        Unit-1921
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1921')]">
        Studio
      </text>
      <!-- 1922 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1922')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1922')]">
        Unit-1922
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1922')]">
        Studio
      </text>
      <!-- 1923 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1923')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1923')]">
        Unit-1923
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1923')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "19th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "19th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "19th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "19th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "19th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
