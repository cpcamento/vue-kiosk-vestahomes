  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('2201')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('2201')]">
        Unit-2201
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('2201')]">
        01 BR
      </text>
      <!-- 2202 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('2202')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('2202')]">
        Unit-2202
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('2202')]">
        Studio
      </text>
      <!-- 2203 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('2203')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('2203')]">
        Unit-2203
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('2203')]">
        Studio
      </text>
      <!-- 2205 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('2205')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('2205')]">
        Unit-2205
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('2205')]">
        01 BR
      </text>
      <!-- 2206 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('2206')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('2206')]">
        Unit-2206
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('2206')]">
        Studio
      </text>
      <!-- 2207 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('2207')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('2207')]">
        Unit-2207
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('2207')]">
        Studio
      </text>
      <!-- 2208 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('2208')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('2208')]">
        Unit-2208
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('2208')]">
        Studio
      </text>
      <!-- 2209 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('2209')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('2209')]">
        Unit-2209
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('2209')]">
        Studio
      </text>
      <!-- 2210 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('2210')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('2210')]">
        Unit-2210
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('2210')]">
        Studio
      </text>
      <!-- 2211 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('2211')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('2211')]">
        Unit-2211
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('2211')]">
        Studio
      </text>
      <!-- 2212-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('2212')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('2212')]">
        Unit-2212
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('2212')]">
        01 BR
      </text>
      <!-- 2215 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('2215')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('2215')]">
        Unit-2215
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('2215')]">
        Studio
      </text>
      <!-- 2216 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('2216')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('2216')]">
        Unit-2216
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('2216')]">
        Studio
      </text>
      <!-- 2217 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('2217')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('2217')]">
        Unit-2217
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('2217')]">
        01 BR
      </text>
      <!-- 2218 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('2218')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('2218')]">
        Unit-2218
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('2218')]">
        Studio
      </text>
      <!-- 2219 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('2219')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('2219')]">
        Unit-2219
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('2219')]">
        Studio
      </text>
      <!-- 2220 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('2220')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('2220')]">
        Unit-2220
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('2220')]">
        Studio
      </text>
      <!-- 2221 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('2221')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('2221')]">
        Unit-2221
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('2221')]">
        Studio
      </text>
      <!-- 2222 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('2222')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('2222')]">
        Unit-2222
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('2222')]">
        Studio
      </text>
      <!-- 2223 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('2223')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('2223')]">
        Unit-2223
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('2223')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "22nd" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "22nd" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "22nd" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "22nd" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "22nd" && data.availability === "Hayat"
      ).length;
    } catch (error) {
