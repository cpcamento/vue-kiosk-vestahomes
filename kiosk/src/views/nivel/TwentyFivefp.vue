  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('2501')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('2501')]">
        Unit-2501
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('2501')]">
        01 BR
      </text>
      <!-- 2502 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('2502')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('2502')]">
        Unit-2502
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('2502')]">
        Studio
      </text>
      <!-- 2503 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('2503')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('2503')]">
        Unit-2503
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('2503')]">
        Studio
      </text>
      <!-- 2505 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('2505')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('2505')]">
        Unit-2505
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('2505')]">
        01 BR
      </text>
      <!-- 2506 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('2506')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('2506')]">
        Unit-2506
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('2506')]">
        Studio
      </text>
      <!-- 2507 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('2507')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('2507')]">
        Unit-2507
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('2507')]">
        Studio
      </text>
      <!-- 2508 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('2508')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('2508')]">
        Unit-2508
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('2508')]">
        Studio
      </text>
      <!-- 2509 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('2509')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('2509')]">
        Unit-2509
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('2509')]">
        Studio
      </text>
      <!-- 2510 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('2510')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('2510')]">
        Unit-2510
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('2510')]">
        Studio
      </text>
      <!-- 2511 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('2511')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('2511')]">
        Unit-2511
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('2511')]">
        Studio
      </text>
      <!-- 2512-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('2512')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('2512')]">
        Unit-2512
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('2512')]">
        01 BR
      </text>
      <!-- 2515 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('2515')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('2515')]">
        Unit-2515
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('2515')]">
        Studio
      </text>
      <!-- 2516 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('2516')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('2516')]">
        Unit-2516
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('2516')]">
        Studio
      </text>
      <!-- 2517 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('2517')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('2517')]">
        Unit-2517
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('2517')]">
        01 BR
      </text>
      <!-- 2518 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('2518')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('2518')]">
        Unit-2518
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('2518')]">
        Studio
      </text>
      <!-- 2519 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('2519')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('2519')]">
        Unit-2519
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('2519')]">
        Studio
      </text>
      <!-- 2520 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('2520')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('2520')]">
        Unit-2520
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('2520')]">
        Studio
      </text>
      <!-- 2521 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('2521')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('2521')]">
        Unit-2521
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('2521')]">
        Studio
      </text>
      <!-- 2522 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('2522')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('2522')]">
        Unit-2522
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('2522')]">
        Studio
      </text>
      <!-- 2523 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('2523')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('2523')]">
        Unit-2523
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('2523')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "25th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "25th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "25th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "25th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "25th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
