  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('1001')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('1001')]">
        Unit-1001
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('1001')]">
        01 BR
      </text>
      <!-- 1002 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('1002')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('1002')]">
        Unit-1002
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('1002')]">
        Studio
      </text>
      <!-- 1003 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('1003')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('1003')]">
        Unit-1003
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('1003')]">
        Studio
      </text>
      <!-- 1005 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('1005')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('1005')]">
        Unit-1005
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('1005')]">
        01 BR
      </text>
      <!-- 1006 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('1006')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('1006')]">
        Unit-1006
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('1006')]">
        Studio
      </text>
      <!-- 1007 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('1007')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('1007')]">
        Unit-1007
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('1007')]">
        Studio
      </text>
      <!-- 1008 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('1008')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('1008')]">
        Unit-1008
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('1008')]">
        Studio
      </text>
      <!-- 1009 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('1009')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('1009')]">
        Unit-1009
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('1009')]">
        Studio
      </text>
      <!-- 1010 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('1010')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('1010')]">
        Unit-1010
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('1010')]">
        Studio
      </text>
      <!-- 1011 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('1011')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('1011')]">
        Unit-1011
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('1011')]">
        Studio
      </text>
      <!-- 1012-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('1012')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('1012')]">
        Unit-1012
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('1012')]">
        01 BR
      </text>
      <!-- 1015 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('1015')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('1015')]">
        Unit-1015
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('1015')]">
        Studio
      </text>
      <!-- 1016 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('1016')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('1016')]">
        Unit-1016
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('1016')]">
        Studio
      </text>
      <!-- 1017 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('1017')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('1017')]">
        Unit-1017
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('1017')]">
        01 BR
      </text>
      <!-- 1018 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('1018')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('1018')]">
        Unit-1018
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('1018')]">
        Studio
      </text>
      <!-- 1019 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('1019')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('1019')]">
        Unit-1019
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('1019')]">
        Studio
      </text>
      <!-- 1020 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('1020')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('1020')]">
        Unit-1020
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('1020')]">
        Studio
      </text>
      <!-- 1021 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('1021')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('1021')]">
        Unit-1021
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('1021')]">
        Studio
      </text>
      <!-- 1022 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('1022')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('1022')]">
        Unit-1022
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('1022')]">
        Studio
      </text>
      <!-- 1023 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('1023')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('1023')]">
        Unit-1023
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('1023')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "10th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "10th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "10th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "10th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "10th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
