  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('601')]"
      ></path>
      <text x="100" y="50" :class="['label', getParkingStatus('601')]">
        Unit-601
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('601')]">
        01 BR
      </text>
      <!-- 602 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('602')]"
      ></path>
      <text x="225" y="95" :class="['label', getParkingStatus('602')]">
        Unit-602
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('602')]">
        Studio
      </text>
      <!-- 603 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('603')]"
      ></path>
      <text x="295" y="95" :class="['label', getParkingStatus('603')]">
        Unit-603
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('603')]">
        Studio
      </text>
      <!-- 605 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('605')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('605')]">
        Unit-605
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('605')]">
        01 BR
      </text>
      <!-- 606 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('606')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('606')]">
        Unit-606
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('606')]">
        Studio
      </text>
      <!-- 607 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('607')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('607')]">
        Unit-607
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('607')]">
        Studio
      </text>
      <!-- 608 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('608')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('608')]">
        Unit-608
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('608')]">
        Studio
      </text>
      <!-- 609 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('609')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('609')]">
        Unit-609
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('609')]">
        Studio
      </text>
      <!-- 610 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('610')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('610')]">
        Unit-610
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('610')]">
        Studio
      </text>
      <!-- 611 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('611')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('611')]">
        Unit-611
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('611')]">
        Studio
      </text>
      <!-- 612-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('612')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('612')]">
        Unit-612
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('612')]">
        01 BR
      </text>
      <!-- 615 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('615')]"
      ></path>
      <text x="295" y="455" :class="['label', getParkingStatus('615')]">
        Unit-615
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('615')]">
        Studio
      </text>
      <!-- 616 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('616')]"
      ></path>
      <text x="225" y="455" :class="['label', getParkingStatus('616')]">
        Unit-616
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('616')]">
        Studio
      </text>
      <!-- 617 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('617')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('617')]">
        Unit-617
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('617')]">
        01 BR
      </text>
      <!-- 618 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('618')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('618')]">
        Unit-618
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('618')]">
        Studio
      </text>
      <!-- 619 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('619')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('619')]">
        Unit-619
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('619')]">
        Studio
      </text>
      <!-- 620 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('620')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('620')]">
        Unit-620
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('620')]">
        Studio
      </text>
      <!-- 621 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('621')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('621')]">
        Unit-621
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('621')]">
        Studio
      </text>
      <!-- 622 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('622')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('622')]">
        Unit-622
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('622')]">
        Studio
      </text>
      <!-- 623 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('623')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('623')]">
        Unit-623
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('623')]">
        Studio
      </text>
