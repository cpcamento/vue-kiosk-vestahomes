  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('701')]"
      ></path>
      <text x="100" y="50" :class="['label', getParkingStatus('701')]">
        Unit-701
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('701')]">
        01 BR
      </text>
      <!-- 702 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('702')]"
      ></path>
      <text x="225" y="95" :class="['label', getParkingStatus('702')]">
        Unit-702
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('702')]">
        Studio
      </text>
      <!-- 703 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('703')]"
      ></path>
      <text x="295" y="95" :class="['label', getParkingStatus('703')]">
        Unit-703
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('703')]">
        Studio
      </text>
      <!-- 705 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('705')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('705')]">
        Unit-705
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('705')]">
        01 BR
      </text>
      <!-- 706 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('706')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('706')]">
        Unit-706
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('706')]">
        Studio
      </text>
      <!-- 707 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('707')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('707')]">
        Unit-707
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('707')]">
        Studio
      </text>
      <!-- 708 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('708')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('708')]">
        Unit-708
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('708')]">
        Studio
      </text>
      <!-- 709 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('709')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('709')]">
        Unit-709
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('709')]">
        Studio
      </text>
      <!-- 710 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('710')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('710')]">
        Unit-710
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('710')]">
        Studio
      </text>
      <!-- 711 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('711')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('711')]">
        Unit-711
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('711')]">
        Studio
      </text>
      <!-- 712-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('712')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('712')]">
        Unit-712
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('712')]">
        01 BR
      </text>
      <!-- 715 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('715')]"
      ></path>
      <text x="295" y="455" :class="['label', getParkingStatus('715')]">
        Unit-715
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('715')]">
        Studio
      </text>
      <!-- 716 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('716')]"
      ></path>
      <text x="225" y="455" :class="['label', getParkingStatus('716')]">
        Unit-716
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('716')]">
        Studio
      </text>
      <!-- 717 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('717')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('717')]">
        Unit-717
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('717')]">
        01 BR
      </text>
      <!-- 718 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('718')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('718')]">
        Unit-718
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('718')]">
        Studio
      </text>
      <!-- 719 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('719')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('719')]">
        Unit-719
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('719')]">
        Studio
      </text>
      <!-- 720 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('720')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('720')]">
        Unit-720
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('720')]">
        Studio
      </text>
      <!-- 721 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('721')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('721')]">
        Unit-721
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('721')]">
        Studio
      </text>
      <!-- 722 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('722')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('722')]">
        Unit-722
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('722')]">
        Studio
      </text>
      <!-- 723 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('723')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('723')]">
        Unit-723
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('723')]">
        Studio
      </text>
