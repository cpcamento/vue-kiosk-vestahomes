  ...
  <div>
    ...
    >
      ...
      <path
        ...
        :class="['unit', getParkingStatus('2301')]"
      ></path>
      <text x="97" y="50" :class="['label', getParkingStatus('2301')]">
        Unit-2301
      </text>
      <text x="110" y="60" :class="['sub-label', getParkingStatus('2301')]">
        01 BR
      </text>
      <!-- 2302 -->
      <path
        d="M 215 40 L 215 153 L 275 153 L 275 147 L 285 147 L 285 40 L 215 40"
        :class="['unit', getParkingStatus('2302')]"
      ></path>
      <text x="218" y="95" :class="['label', getParkingStatus('2302')]">
        Unit-2302
      </text>
      <text x="237" y="105" :class="['sub-label', getParkingStatus('2302')]">
        Studio
      </text>
      <!-- 2303 -->
      <path
        d="M 285 40 L 285 147 L 295 147 L 295 154 L 359 154 L 359 40 L 285 40"
        :class="['unit', getParkingStatus('2303')]"
      ></path>
      <text x="290" y="95" :class="['label', getParkingStatus('2303')]">
        Unit-2303
      </text>
      <text x="307" y="105" :class="['sub-label', getParkingStatus('2303')]">
        Studio
      </text>
      <!-- 2305 -->
      <path
        d="M 394 110 L 359 110 L 359 22 L 479 22 L 479 40 L 519 40 L 519 87 L 404 87 L 404 80 L 394 80"
        :class="['unit', getParkingStatus('2305')]"
      ></path>
      <text x="425" y="60" :class="['label', getParkingStatus('2305')]">
        Unit-2305
      </text>
      <text x="437" y="70" :class="['sub-label', getParkingStatus('2305')]">
        01 BR
      </text>
      <!-- 2306 -->
      <path
        d="M 394 154 L 519 154 L 519 87 L 404 87 L 404 94 L 394 94"
        :class="['unit', getParkingStatus('2306')]"
      ></path>
      <text x="425" y="125" :class="['label', getParkingStatus('2306')]">
        Unit-2306
      </text>
      <text x="437" y="135" :class="['sub-label', getParkingStatus('2306')]">
        Studio
      </text>
      <!-- 2307 -->
      <path
        d="M 394 154 L 519 154 L 519 214 L 404 214 L 404 207 L 394 207"
        :class="['unit', getParkingStatus('2307')]"
      ></path>
      <text x="425" y="185" :class="['label', getParkingStatus('2307')]">
        Unit-2307
      </text>
      <text x="437" y="195" :class="['sub-label', getParkingStatus('2307')]">
        Studio
      </text>
      <!-- 2308 -->
      <path
        d="M 394 274 L 519 274 L 519 214 L 404 214 L 404 221 L 394 221"
        :class="['unit', getParkingStatus('2308')]"
      ></path>
      <text x="425" y="245" :class="['label', getParkingStatus('2308')]">
        Unit-2308
      </text>
      <text x="437" y="255" :class="['sub-label', getParkingStatus('2308')]">
        Studio
      </text>
      <!-- 2309 -->
      <path
        d="M 394 274 L 519 274 L 519 334 L 405 334 L 405 328 L 394 328"
        :class="['unit', getParkingStatus('2309')]"
      ></path>
      <text x="425" y="305" :class="['label', getParkingStatus('2309')]">
        Unit-2309
      </text>
      <text x="437" y="315" :class="['sub-label', getParkingStatus('2309')]">
        Studio
      </text>
      <!-- 2310 -->
      <path
        d="M 394 394 L 519 394 L 519 334 L 405 334 L 405 341 L 394 341"
        :class="['unit', getParkingStatus('2310')]"
      ></path>
      <text x="425" y="365" :class="['label', getParkingStatus('2310')]">
        Unit-2310
      </text>
      <text x="437" y="375" :class="['sub-label', getParkingStatus('2310')]">
        Studio
      </text>
      <!-- 2311 -->
      <path
        d="M 394 394 L 519 394 L 519 453 L 405 453 L 405 448 L 394 448"
        :class="['unit', getParkingStatus('2311')]"
      ></path>
      <text x="425" y="425" :class="['label', getParkingStatus('2311')]">
        Unit-2311
      </text>
      <text x="437" y="435" :class="['sub-label', getParkingStatus('2311')]">
        Studio
      </text>
      <!-- 2312-->
      <path
        d="M 395 434 L 360 434 L 360 515 L 479 515 L 479 492 L 519 492 L 519 453 L 405 453 L 405 460 L 394 460"
        :class="['unit', getParkingStatus('2312')]"
      ></path>
      <text x="425" y="485" :class="['label', getParkingStatus('2312')]">
        Unit-2312
      </text>
      <text x="437" y="495" :class="['sub-label', getParkingStatus('2312')]">
        01 BR
      </text>
      <!-- 2315 -->
      <path
        d="M 285 404 L 285 514 L 359 514 L 359 394 L 295 394 L 295 404 L 285 404"
        :class="['unit', getParkingStatus('2315')]"
      ></path>
      <text x="290" y="455" :class="['label', getParkingStatus('2315')]">
        Unit-2315
      </text>
      <text x="307" y="465" :class="['sub-label', getParkingStatus('2315')]">
        Studio
      </text>
      <!-- 2316 -->
      <path
        d="M 215 394 L 215 514 L 285 514 L 285 404 L 275 404 L 275 394 L 215 394"
        :class="['unit', getParkingStatus('2316')]"
      ></path>
      <text x="218" y="455" :class="['label', getParkingStatus('2316')]">
        Unit-2316
      </text>
      <text x="237" y="465" :class="['sub-label', getParkingStatus('2316')]">
        Studio
      </text>
      <!-- 2317 -->
      <path
        d="M 180 460 L 170 460 L 170 454 L 52 454 L 52 492 L 90 492 L 90 514 L 215 514 L 215 435 L 180 435"
        :class="['unit', getParkingStatus('2317')]"
      ></path>
      <text x="90" y="485" :class="['label', getParkingStatus('2317')]">
        Unit-2317
      </text>
      <text x="102" y="495" :class="['sub-label', getParkingStatus('2317')]">
        01 BR
      </text>
      <!-- 2318 -->
      <path
        d="M 52 394 L 180 394 L 180 448 L 170 448 L 170 454 L 52 454 L 52 394"
        :class="['unit', getParkingStatus('2318')]"
      ></path>
      <text x="90" y="425" :class="['label', getParkingStatus('2318')]">
        Unit-2318
      </text>
      <text x="102" y="435" :class="['sub-label', getParkingStatus('2318')]">
        Studio
      </text>
      <!-- 2319 -->
      <path
        d="M 52 334 L 170 334 L 170 340 L 180 340 L 180 394 L 52 394 L 52 334"
        :class="['unit', getParkingStatus('2319')]"
      ></path>
      <text x="90" y="365" :class="['label', getParkingStatus('2319')]">
        Unit-2319
      </text>
      <text x="102" y="375" :class="['sub-label', getParkingStatus('2319')]">
        Studio
      </text>
      <!-- 2320 -->
      <path
        d="M 52 274 180 274 L 180 328 L 170 328 L 170 334 L 52 334 L 52 274"
        :class="['unit', getParkingStatus('2320')]"
      ></path>
      <text x="90" y="305" :class="['label', getParkingStatus('2320')]">
        Unit-2320
      </text>
      <text x="102" y="315" :class="['sub-label', getParkingStatus('2320')]">
        Studio
      </text>
      <!-- 2321 -->
      <path
        d="M 52 214 L 170 214 L 170 220 L 180 220 L 180 274 L 52 274 L 52 214"
        :class="['unit', getParkingStatus('2321')]"
      ></path>
      <text x="90" y="245" :class="['label', getParkingStatus('2321')]">
        Unit-2321
      </text>
      <text x="102" y="255" :class="['sub-label', getParkingStatus('2321')]">
        Studio
      </text>
      <!-- 2322 -->
      <path
        d="M 52 153 L 180 153 L 180 207 L 170 207 L 170 213 L 52 213 L 52 153"
        :class="['unit', getParkingStatus('2322')]"
      ></path>
      <text x="90" y="185" :class="['label', getParkingStatus('2322')]">
        Unit-2322
      </text>
      <text x="102" y="195" :class="['sub-label', getParkingStatus('2322')]">
        Studio
      </text>
      <!-- 2323 -->
      <path
        d="M 52 87 L 170 87 L 170 93 L 180 93 L 180 153 L 52 153 L 52 87"
        :class="['unit', getParkingStatus('2323')]"
      ></path>
      <text x="90" y="120" :class="['label', getParkingStatus('2323')]">
        Unit-2323
      </text>
      <text x="102" y="130" :class="['sub-label', getParkingStatus('2323')]">
        Studio
      </text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "23rd" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "23rd" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "23rd" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "23rd" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "23rd" && data.availability === "Hayat"
      ).length;
    } catch (error) {
