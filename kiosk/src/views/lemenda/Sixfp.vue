      ...
      <svg viewBox="-150 50 940 430" class="floorplan">
        <g>
          ...
          <path
            ...
            :class="['floorplan', 'unit', getUnitStatus('601')]"
          ></path>
          <text x="55" y="165" :class="getUnitStatus('601')">UNIT-601</text>
          <text x="61" y="175" :class="getUnitStatus('601')">01 BR</text>
          <!-- 302 -->
          <rect
            x="90"
            y="120"
            width="40"
            height="80"
            :class="['floorplan', 'unit', getUnitStatus('602')]"
          ></rect>
          <text x="95" y="165" :class="getUnitStatus('602')">UNIT-602</text>
          <text x="101" y="175" :class="getUnitStatus('602')">01 BR</text>
          <!-- 303 -->
          <rect
            x="130"
            y="120"
            width="40"
            height="80"
            :class="['floorplan', 'unit', getUnitStatus('603')]"
          ></rect>
          <text x="135" y="165" :class="getUnitStatus('603')">UNIT-603</text>
          <text x="141" y="175" :class="getUnitStatus('603')">01 BR</text>
          <!-- 304 -->
          <rect
            x="170"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('604')]"
          ></rect>
          <text x="175" y="165" :class="getUnitStatus('604')">UNIT-604</text>
          <text x="181" y="175" :class="getUnitStatus('604')">01 BR</text>
          <!-- 305 -->
          <rect
            x="210"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('605')]"
          ></rect>
          <text x="215" y="165" :class="getUnitStatus('605')">UNIT-605</text>
          <text x="221" y="175" :class="getUnitStatus('605')">01 BR</text>
          <!-- 306 -->
          <rect
            x="250"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('606')]"
          ></rect>
          <text x="255" y="165" :class="getUnitStatus('606')">UNIT-606</text>
          <text x="261" y="175" :class="getUnitStatus('606')">01 BR</text>
          <!-- 307 -->
          <path
            d="M 290 120 L 315 120 L 315 130 L 330 130 L 330 150 L 350 175 L 330 200 L 290 200"
            :class="['floorplan', 'unit', getUnitStatus('607')]"
          ></path>
          <text x="295" y="165" :class="getUnitStatus('607')">UNIT-607</text>
          <text x="301" y="175" :class="getUnitStatus('607')">01 BR</text>
        </g>
        <g>
          <!-- 308 -->
          <rect
            ...
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('608')]"
          ></rect>
          <text x="55" y="265" :class="getUnitStatus('608')">UNIT-608</text>
          <text x="61" y="275" :class="getUnitStatus('608')">01 BR</text>
          <!-- 309 -->
          <rect
            x="90"
            y="220"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('609')]"
          ></rect>
          <text x="95" y="265" :class="getUnitStatus('609')">UNIT-609</text>
          <text x="101" y="275" :class="getUnitStatus('609')">01 BR</text>
          <!-- 310 -->
          <rect
            x="130"
            y="220"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('610')]"
          ></rect>
          <text x="135" y="265" :class="getUnitStatus('610')">UNIT-610</text>
          <text x="141" y="275" :class="getUnitStatus('610')">01 BR</text>
          <!-- 311 -->
          <rect
            x="170"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('611')]"
          ></rect>
          <text x="175" y="250" :class="getUnitStatus('611')">UNIT-611</text>
          <text x="181" y="260" :class="getUnitStatus('611')">Studio</text>
          <!-- 312 -->
          <rect
            x="210"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('612')]"
          ></rect>
          <text x="215" y="250" :class="getUnitStatus('612')">UNIT-612</text>
          <text x="221" y="260" :class="getUnitStatus('612')">Studio</text>
          <!-- 313 -->
          <rect
            x="250"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('613')]"
          ></rect>
          <text x="255" y="250" :class="getUnitStatus('613')">UNIT-613</text>
          <text x="261" y="260" :class="getUnitStatus('613')">Studio</text>
          <!-- 314 -->
          <path
            d="M 290 220 L 340 220 L 358 200 L 386 228 L 350 263 L 350 280 L 290 280"
            :class="['floorplan', 'unit', getUnitStatus('614')]"
          ></path>
          <text x="305" y="250" :class="getUnitStatus('614')">UNIT-614</text>
          <text x="311" y="260" :class="getUnitStatus('614')">02 BR</text>
        </g>
        <g style="transform: rotate(45deg) translate(334px, -162px)">
          ...
          <path
            ...
            :class="['floorplan', 'unit', getUnitStatus('615')]"
          ></path>
          <text x="105" y="55" :class="getUnitStatus('615')">UNIT-615</text>
          <text x="114" y="65" :class="getUnitStatus('615')">01 BR</text>
          <!-- 316 -->
          <path
            d="M 140 2 L 180 2 L 180 100 L 140 100 L 140 2"
            :class="['floorplan', 'unit', getUnitStatus('616')]"
          ></path>
          <text x="145" y="55" :class="getUnitStatus('616')">UNIT-616</text>
          <text x="154" y="65" :class="getUnitStatus('616')">01 BR</text>
          <!-- 317 -->
          <path
            d="M 180 2 L 220 2 L 220 80 L 200 80 L 200 100 L 180 100"
            :class="['floorplan', 'unit', getUnitStatus('617')]"
          ></path>
          <text x="185" y="40" :class="getUnitStatus('617')">UNIT-617</text>
          <text x="194" y="50" :class="getUnitStatus('617')">01 BR</text>
          <!-- 318 -->
          <path
            d="M 220 2 L 260 2 L 260 70 L 220 70"
            :class="['floorplan', 'unit', getUnitStatus('618')]"
          ></path>
          <text x="225" y="40" :class="getUnitStatus('618')">UNIT-618</text>
          <text x="234" y="50" :class="getUnitStatus('618')">01 BR</text>
          <!-- 319 -->
          <path
            d="M 260 2 L 320 2 L 320 70 L 260 70"
            :class="['floorplan', 'unit', getUnitStatus('619')]"
          ></path>
          <text x="275" y="40" :class="getUnitStatus('619')">UNIT-619</text>
          <text x="284" y="50" :class="getUnitStatus('619')">02 BR</text>
          <!-- 320 -->
          <path
            d="M 320 2 L 350 2 L 350 20 L 390 20 L 390 70 L 375 70 L 375 80 L 320 80 L 320 2"
            :class="['floorplan', 'unit', getUnitStatus('620')]"
          ></path>
          <text x="335" y="40" :class="getUnitStatus('620')">UNIT-620</text>
          <text x="344" y="50" :class="getUnitStatus('620')">02 BR</text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "6th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "6th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "6th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "6th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "6th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
