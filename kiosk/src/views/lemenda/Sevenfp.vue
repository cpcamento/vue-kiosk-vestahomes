      ...
      <svg viewBox="-150 50 940 430" class="floorplan">
        <g>
          ...
          <path
            ...
            :class="['floorplan', 'unit', getUnitStatus('701')]"
          ></path>
          <text x="55" y="165" :class="getUnitStatus('701')">UNIT-701</text>
          <text x="61" y="175" :class="getUnitStatus('701')">01 BR</text>
          <!-- 302 -->
          <rect
            x="90"
            y="120"
            width="40"
            height="80"
            :class="['floorplan', 'unit', getUnitStatus('702')]"
          ></rect>
          <text x="95" y="165" :class="getUnitStatus('702')">UNIT-702</text>
          <text x="101" y="175" :class="getUnitStatus('702')">01 BR</text>
          <!-- 303 -->
          <rect
            x="130"
            y="120"
            width="40"
            height="80"
            :class="['floorplan', 'unit', getUnitStatus('703')]"
          ></rect>
          <text x="135" y="165" :class="getUnitStatus('703')">UNIT-703</text>
          <text x="141" y="175" :class="getUnitStatus('703')">01 BR</text>
          <!-- 304 -->
          <rect
            x="170"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('704')]"
          ></rect>
          <text x="175" y="165" :class="getUnitStatus('704')">UNIT-704</text>
          <text x="181" y="175" :class="getUnitStatus('704')">01 BR</text>
          <!-- 305 -->
          <rect
            x="210"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('705')]"
          ></rect>
          <text x="215" y="165" :class="getUnitStatus('705')">UNIT-705</text>
          <text x="221" y="175" :class="getUnitStatus('705')">01 BR</text>
          <!-- 306 -->
          <rect
            x="250"
            y="110"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('706')]"
          ></rect>
          <text x="255" y="165" :class="getUnitStatus('706')">UNIT-706</text>
          <text x="261" y="175" :class="getUnitStatus('706')">01 BR</text>
          <!-- 307 -->
          <path
            d="M 290 120 L 315 120 L 315 130 L 330 130 L 330 150 L 350 175 L 330 200 L 290 200"
            :class="['floorplan', 'unit', getUnitStatus('707')]"
          ></path>
          <text x="295" y="165" :class="getUnitStatus('707')">UNIT-707</text>
          <text x="301" y="175" :class="getUnitStatus('707')">01 BR</text>
        </g>
        <g>
          <!-- 308 -->
          <rect
            ...
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('708')]"
          ></rect>
          <text x="55" y="265" :class="getUnitStatus('708')">UNIT-708</text>
          <text x="61" y="275" :class="getUnitStatus('708')">01 BR</text>
          <!-- 309 -->
          <rect
            x="90"
            y="220"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('709')]"
          ></rect>
          <text x="95" y="265" :class="getUnitStatus('709')">UNIT-709</text>
          <text x="101" y="275" :class="getUnitStatus('709')">01 BR</text>
          <!-- 310 -->
          <rect
            x="130"
            y="220"
            width="40"
            height="90"
            :class="['floorplan', 'unit', getUnitStatus('710')]"
          ></rect>
          <text x="135" y="265" :class="getUnitStatus('710')">UNIT-710</text>
          <text x="141" y="275" :class="getUnitStatus('710')">01 BR</text>
          <!-- 311 -->
          <rect
            x="170"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('711')]"
          ></rect>
          <text x="175" y="250" :class="getUnitStatus('711')">UNIT-711</text>
          <text x="181" y="260" :class="getUnitStatus('711')">Studio</text>
          <!-- 312 -->
          <rect
            x="210"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('712')]"
          ></rect>
          <text x="215" y="250" :class="getUnitStatus('712')">UNIT-712</text>
          <text x="221" y="260" :class="getUnitStatus('712')">Studio</text>
          <!-- 313 -->
          <rect
            x="250"
            y="220"
            width="40"
            height="60"
            :class="['floorplan', 'unit', getUnitStatus('713')]"
          ></rect>
          <text x="255" y="250" :class="getUnitStatus('713')">UNIT-713</text>
          <text x="261" y="260" :class="getUnitStatus('713')">Studio</text>
          <!-- 314 -->
          <path
            d="M 290 220 L 340 220 L 358 200 L 386 228 L 350 263 L 350 280 L 290 280"
            :class="['floorplan', 'unit', getUnitStatus('714')]"
          ></path>
          <text x="305" y="250" :class="getUnitStatus('714')">UNIT-714</text>
          <text x="311" y="260" :class="getUnitStatus('714')">02 BR</text>
        </g>
        <g style="transform: rotate(45deg) translate(334px, -162px)">
          ...
          <path
            ...
            :class="['floorplan', 'unit', getUnitStatus('715')]"
          ></path>
          <text x="105" y="55" :class="getUnitStatus('715')">UNIT-715</text>
          <text x="114" y="65" :class="getUnitStatus('715')">01 BR</text>
          <!-- 316 -->
          <path
            d="M 140 2 L 180 2 L 180 100 L 140 100 L 140 2"
            :class="['floorplan', 'unit', getUnitStatus('716')]"
          ></path>
          <text x="145" y="55" :class="getUnitStatus('716')">UNIT-716</text>
          <text x="154" y="65" :class="getUnitStatus('716')">01 BR</text>
          <!-- 317 -->
          <path
            d="M 180 2 L 220 2 L 220 80 L 200 80 L 200 100 L 180 100"
            :class="['floorplan', 'unit', getUnitStatus('717')]"
          ></path>
          <text x="185" y="40" :class="getUnitStatus('717')">UNIT-717</text>
          <text x="194" y="50" :class="getUnitStatus('717')">01 BR</text>
          <!-- 318 -->
          <path
            d="M 220 2 L 260 2 L 260 70 L 220 70"
            :class="['floorplan', 'unit', getUnitStatus('718')]"
          ></path>
          <text x="225" y="40" :class="getUnitStatus('718')">UNIT-718</text>
          <text x="234" y="50" :class="getUnitStatus('718')">01 BR</text>
          <!-- 319 -->
          <path
            d="M 260 2 L 320 2 L 320 70 L 260 70"
            :class="['floorplan', 'unit', getUnitStatus('719')]"
          ></path>
          <text x="275" y="40" :class="getUnitStatus('719')">UNIT-719</text>
          <text x="284" y="50" :class="getUnitStatus('719')">02 BR</text>
          <!-- 320 -->
          <path
            d="M 320 2 L 350 2 L 350 20 L 390 20 L 390 70 L 375 70 L 375 80 L 320 80 L 320 2"
            :class="['floorplan', 'unit', getUnitStatus('720')]"
          ></path>
          <text x="335" y="40" :class="getUnitStatus('720')">UNIT-720</text>
          <text x="344" y="50" :class="getUnitStatus('720')">02 BR</text>
  ...
  mounted: async function () {
    try {
      ...
      this.available = this.floorData.filter(
        (data) => data.floor === "7th" && data.availability === "Available"
      ).length;
      this.sold = this.floorData.filter(
        (data) => data.floor === "7th" && data.availability === "Sold"
      ).length;
      this.reserved = this.floorData.filter(
        (data) => data.floor === "7th" && data.availability === "Reserved"
      ).length;
      this.blocked = this.floorData.filter(
        (data) => data.floor === "7th" && data.availability === "Blocked"
      ).length;
      this.hayat = this.floorData.filter(
        (data) => data.floor === "7th" && data.availability === "Hayat"
      ).length;
    } catch (error) {
